/**
 * Firecracker Instance Stop API Route
 */
...
/**
 * POST /api/infrastructure/firecracker/[instanceId]/stop
 * Stop a Firecracker instance
 */
export async function POST(request: NextRequest, { params }: RouteParams) {
  try {
    ...
    const response = await firecrackerService.stopInstance(instanceId);
    ...
    console.error('Error stopping Firecracker instance:', error);
